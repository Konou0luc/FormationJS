...
// recperer des elements pour le projet


// detecter quand le bouton nouvelle citation serait cliqué

function genererNonbmreEntier(max){
    return Math.floor(Math.random() * max ) ;// 0.8 * 10 = 8
}


nouveau.addEventListener('click', function(){
    nombreAleatoire  = genererNonbmreEntier(citations.length);
